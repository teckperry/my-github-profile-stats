...
// A plain comment naming the project, so the cards it produces can be counted by
// searching for it. Nothing is sent anywhere and nothing is hidden: it sits in the file
// you publish, and deleting it costs one line if you would rather not carry it.
const SIGNATURE =
